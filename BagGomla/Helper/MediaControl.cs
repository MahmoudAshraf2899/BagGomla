...
namespace BagGomla.Helper
{
    public class MediaControl
    {
        ...
        public static string Upload(FilePath filePath, byte[] FileBytes)
        {
            string FolderPath = string.Empty;
            ...
            if (FileBytes != null && FileBytes.Length > 0)
            {
                ...
                {
                    case FilePath.Users:
                        FolderPath = HttpContext.Current.Server.MapPath("~/Images/Users");
                        break;
                    case FilePath.Other:
                        FolderPath = HttpContext.Current.Server.MapPath("~/Images/Other");
                        break;
                    case FilePath.Job:
                        FolderPath = HttpContext.Current.Server.MapPath("~/Images/Jobs");
                        break;
                    case FilePath.Product:
                        FolderPath = HttpContext.Current.Server.MapPath("~/Images/Products");
                        break;
                    case FilePath.Category:
                        FolderPath = HttpContext.Current.Server.MapPath("~/Images/Categories");
                        break;
                    default:
                        break;
                }
        ...
        public static string CopyFile(string FileName, FilePath FromFilePath, FilePath ToFilePath)
        {
